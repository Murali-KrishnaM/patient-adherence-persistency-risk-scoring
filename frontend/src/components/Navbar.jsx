      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            title="Configure FastAPI Backend Server"
          >
            {apiStatus.online ? (
              <>
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-ping"></span>
                <span className="text-emerald-600 dark:text-emerald-400 font-mono text-[11px]">FastAPI Ready</span>
              </>
            ) : (
              <>
                <Zap className="w-3.5 h-3.5 text-emerald-500" />
                <span className="text-[11px]">Local ML Engine</span>
              </>
            )}
          </button>
          ...
          {/* New Analysis Button - Always Kept & Clickable */}
          <button
