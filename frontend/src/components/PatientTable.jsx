      ...
      <div className="glass-panel rounded-2xl overflow-hidden shadow-xl border">
                      ...
                      <td className="py-3.5 px-4 text-center">
                        {isActionable ? (
                          <ConfirmButton
                            ...
                            className="px-2.5 py-1 rounded-full text-[11px] font-semibold border inline-flex items-center space-x-1 bg-amber-100 text-amber-800 border-amber-300 hover:bg-amber-200 dark:bg-amber-950/60 dark:text-amber-300 dark:border-amber-500/40 dark:hover:bg-amber-900/60 transition-colors"
                            icon={<PhoneCall className="w-3 h-3 text-amber-500" />}
                            label={patient.contact_status}
        ...
        <div className="bg-slate-50 dark:bg-dark-950/90 px-4 py-2.5 border-t border-slate-200 dark:border-emerald-500/10 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400">
          ...
          <span className="font-mono text-[11px] text-emerald-700 dark:text-emerald-400 font-semibold">
            Click Snooze or Pending Contact twice to confirm • Hover Risk Status for model factors
          </span>
        </div>
      </div>
    </div>
